...
function AccordionSection() {
  return (
    <section className="max-w-5xl my-4 mx-auto h-auto">
        <h4 className="text-blue-700 font-semibold text-4xl text-center py-6">Frequently asked questions on solar panel</h4>
       <Accordion className="w-full">
            <AccordionItem>
                <AccordionItemHeading className="text-2xl font-semibold font-Poppins ">
                    <AccordionItemButton>
