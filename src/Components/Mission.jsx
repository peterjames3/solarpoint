...
function Mission() {
  return (
    ...
    <div className="relative px-2 py-3 space-y-6 flex-1">
      <h4 className='text-5xl text-blue-700 font-semibold hover:underline transition-all delay-300 cursor-pointer'>Our Mission</h4>
    ...
    <div className='divider-animate bg-green-500 transition-all ease-in-out duration-500'></div> {/* Placeholder for visibility */}
    <div className="relative px-3 py-3 space-y-6 flex-1">
      <h4 className='text-5xl font-semibold text-blue-700 hover:underline transition-all delay-300 cursor-pointer'>Our Vision</h4>
