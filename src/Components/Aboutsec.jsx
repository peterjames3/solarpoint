...
function Aboutus() {
  return (
    <section
      ...
      className="max-w-[1400px] my-20 mx-auto px-10  "
    >
      <section className="w-full pb-4 flex flex-col items-center space-y-3">
      ...
      <div className=" max-w-8xl mx-auto  mt-4 gap-4 grid grid-rows-1 ss:grid-cols-2 sm:gap-3 sm:grid-cols-3 md:flex lg:flex ">
        <div className="space-y-5 h-[28rem] md:h-[26.7rem] pb-2 px-2 w-full md:w-[35%] pt-2 text-white text-center rounded-md shadow-lg bg-white dark:bg-gray-800 hover:scale-100 transition-all delay-300 border-y-4 border-green-700">
          <h4 className="text-2xl font-semibold font-Inter pt-5">
            We Are Commited to provide Quality Service
          </h4>
          <p className="font-medium">
            We have over two decades of experience, our mission remains to empower
