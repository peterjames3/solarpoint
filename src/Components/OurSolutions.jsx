...
function OurSolutions() {
  return (
    <section className="w-full px-2  md:px-3 my-4 mx-auto  flex flex-col space-y-5">
      ...
      <div className=" wrapper grid  grid-rows-3 grid-cols-1 gap-0 sm:gap-3 md:gap-8 sm:grid-rows-1 sm:grid-cols-3  ">
        <div className="flex w-full space-y-10 items-center flex-col md:space-y-12 py-5 h-full  ss:space-y-3">
          <div
            data-aos="fade-right"
            data-aos-delay="70"
            className="card flex  w-full justify-around gap-2 hover:scale-105 transform duration-300 ease-in-out hover:bg-cardBg cursor-pointer  hover:shadow-md hover:shadow-black"
          >
            <div className="w-[30%] ">
              <img
                src={solarSVG}
          ...
          <div
            data-aos="fade-right"
            data-aos-delay="70"
            className="card_1 flex  justify-around  gap-2 hover:scale-105 transform duration-300 ease-in-out hover:bg-cardBg cursor-pointer hover:shadow-md hover:shadow-black"
          >
            <div className="w-[30%]">
              <img
                src={solarEnergy}
          ...
          <div
            data-aos="fade-right"
            data-aos-delay="70"
            className="card_2 flex  justify-around  gap-2 hover:scale-105 transform duration-300 ease-in-out hover:bg-cardBg cursor-pointer  hover:shadow-md hover:shadow-black"
          >
            <div className="w-[30%]">
              <img
                src={Powergeneration}
        ...
        <div className="flex  w-full space-y-10  items-center flex-col md:space-y-12 py-5 h-full  ss:space-y-3">
          <div
            data-aos="fade-left"
            data-aos-delay="70"
            className="card_3 flex justify-around  gap-2 hover:scale-105 transform duration-300 ease-in-out hover:bg-cardBg cursor-pointer  hover:shadow-md hover:shadow-black"
          >
            <div className="w-[30%]">
              <img
                src={waterHeater}
          ...
          <div
            data-aos="fade-left"
            data-aos-delay="70"
            className="card_4 flex justify-around gap-2  hover:scale-105 transform duration-300 ease-in-out hover:bg-cardBg cursor-pointer hover:shadow-md hover:shadow-black"
          >
            <div className="w-[30%]">
              <img
                src={Bulb}
          ...
          <div
            data-aos="fade-left"
            data-aos-delay="70"
            className="card_5 flex justify-around gap-2 hover:scale-105 transform duration-300 ease-in-out hover:bg-cardBg cursor-pointer  hover:shadow-md hover:shadow-black"
          >
            <div className="w-[30%]">
              <img
                src={Pump}
