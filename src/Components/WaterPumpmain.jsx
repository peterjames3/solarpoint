...
function WaterPumpmain() {
  return (
    ...
    data-aos-duration="3000" className="h-auto my-5 py-20 overflow-y-scroll">
      <div className="max-w-[1400px] my-10 mx-auto flex flex-col sx:flex-col ss:flex-row md:flex-row md:gap-5  md:px-7 bg-slate-300 py-3">
      ...
      <div className="How it works max-w-7xl my-4 mx-auto">
