...
function OurAchievements() {
  return (
      ...
      data-aos-duration="3000" className="w-full   py-7 px-10  ">
        ...
        <div className="max-w-[1400px] bg-[#EAFDF8] grid grid-rows-4 grid-cols-1 xs:grid-col-2 xs:grid-rows-2 ss:grid-cols-2 ss:grid-rows-2  md:grid-rows-1 md:grid-cols-4 gap-3 my-2 mx-auto">
          ...
          sm:min-h-[30rem] py-5">
            <div className="h-[40%] w-full flex items-center justify-center">
              <FaGoogleWallet className="text-9xl text-yellow-950" />
            </div>
          ...
          <div className="rounded-sm overflow-y-auto  shadow-md shadow-slate-800 text-center items-center flex flex-col px-2 bg-white">
            <div className="h-[40%] w-full flex items-center justify-center">
              <GrInstallOption className="text-9xl text-yellow-950" />
            </div>
            <div className="h-[60%] w-full text-center space-y-2">
          ...
          <div className="rounded-sm overflow-y-auto  shadow-md shadow-slate-800 text-center items-center flex flex-col px-2 bg-white">
            <div className="h-[40%] w-full flex items-center justify-center">
              <TbBrandGoogleAnalytics className="text-9xl text-yellow-950" />
            </div>
            <div className="h-[60%] w-full text-center space-y-2">
          ...
          <div className="rounded-sm overflow-y-auto shadow-md shadow-slate-800 text-center items-center flex flex-col px-2 bg-white">
            <div className="h-[40%] w-full flex items-center justify-center">
              <MdOutlineCo2 className="text-9xl text-yellow-950" />
            </div>
            <div className="h-[60%] w-full text-center space-y-2">
              <h5 className="text-2xl font-medium">
